...
###############################################################################
str(Profiler_SA18)
Profiler_SA18 <- read_csv("../Raw Data/Profiler/StAlbansInner_2018_Profiler.csv") %>%
  ...
  mutate(Remove = if_else(Depth == 0.5 & Chl_RFU > 60, "Yes", "No"),
         Remove = if_else(Depth == 1 & Chl_RFU > 17.5, "Yes", Remove),
         Remove = if_else(Depth == 1.5 & Chl_RFU > 20, "Yes", Remove),
         Remove = if_else(Depth == 2 & Chl_RFU > 20, "Yes", Remove),
         Remove = if_else(Depth == 1 & Turbid > 100, "Yes", Remove)) %>%
  filter(Remove == "No")
...
write.csv(Profiler_SA18, file="..//Clean Data/SA_Profiler_2018_Clean.csv")
